/*
 * Writted by: Tamir Tabak
 * This example shows how to rotate the stepper motor one step at a time 
 * with StepperMotor library
 */
...
void loop() 
{
  ...
  {
    cartMotor.oneStep(RPM,stepsPerRevolution,CCW);
  }
  delay(1000);
  ...
  for (int i = 0; i<stepsPerRevolution; i++)
  {
    cartMotor.oneStep(RPM,stepsPerRevolution,CW);
  }
  delay(1000);
}
